...
public class UDPClient {
    ...
    public synchronized static boolean bookAppointment(int port, String clientID,String patientID, String appointmentID, String appointmentType) throws ClassNotFoundException, IOException{
    	DatagramSocket SocketCli=null;
    	InetAddress IPAddress = null;
    	byte[] incomingData = null;
    	byte[] data = null;
		...
		Message message = (Message) BytesUtil.toObject(dataBack);
		Map<String, Map<String,ArrayList<String>>> map = message.getMap();
		...
		Message msg2 = new Message(map);
		data = BytesUtil.toByteArray(msg2);
		sendPacket = new DatagramPacket(data, data.length, IPAddress, port);
		SocketCli.send(sendPacket);
    ...
    public synchronized static void sendMap(int port, Map<String, Map<String,ArrayList<String>>> map) throws Exception{
    	DatagramSocket SocketCli=null;
    	InetAddress IPAddress = null;
    	byte[] incomingData = null;
...
//    	ObjectOutputStream os = null;
    	...
    	Message msg = new Message("Connect for modifying");
    	msg.setMap(map);
