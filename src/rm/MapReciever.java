...
public class MapReciever {

    public static StdMaps getStdMaps(int sk2_dst_port, int sk3_dst_port){
        int pkt_size = 1000;
        StdMaps message = null;
...
//                                System.out.println("Receiver: Sent Ack " + seqNum);
                            ...
                            if (seqNum==0 && prevSeqNum==-1){
                                ...
                                byte[] dataBack = copyOfRange(in_data, 16, 16 + fileNameLength);
                                message = (StdMaps) BytesUtil.toObject(dataBack);
                                message.print();
...
//                System.out.println("Receiver: sk3 closed!");
    ...
    // generate Ack packet
    public static byte[] generatePacket(int ackNum){
